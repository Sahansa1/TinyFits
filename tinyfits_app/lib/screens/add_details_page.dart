...
class _AddDetailsPageState extends State<AddDetailsPage> {
  ...
  bool _selectedPastMeasurements = false; // ✅ New flag
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    /// **Checkbox for Selecting Past Measurements**
                    CheckboxListTile(
                      title: const Text("Enter Past Measurements Instead"),
                      value: _selectedPastMeasurements,
                      onChanged: (bool? value) {
                        setState(() {
                          _selectedPastMeasurements = value ?? false;
                        });
                      },
                    ),

                    /// **Conditional Input Fields**
                    if (!_selectedPastMeasurements) ...[
                      _buildTextField("Height (in cm)", _heightController),
                      _buildTextField("Weight (in kg)", _weightController),
                    ],
  ...
  void _saveChild() {
    if (!_selectedPastMeasurements &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content:
              Text("Enter either past measurements or today's height & weight"),
